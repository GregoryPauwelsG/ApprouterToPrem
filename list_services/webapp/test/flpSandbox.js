		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "List Services",
									"targetURL": "#listservices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"listservices-display": {
								"semanticObject": "listservices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=listservices",
									"url": sap.ui.require.toUrl("listservices")
								}
							}
						}
					}
